...
// ANSWER: Yes, they are both Linear Space O(n)
...
// ANSWER: We decided that both of them depended on the length of the string being passed into them. 
...
class Factorial {
  ...
  this.cache[num]=theAnswer
  return theAnswer
}}}

// let factorial = new Factorial 
// console.log(factorial.calcFac(4))
// console.log(factorial.calcFac(4))
